...
- **Windows**: download `QuietValley-win-x64.zip`, extract it, open the `QuietValley` folder, and run `QuietValley.Game.exe`. Windows SmartScreen may warn on first launch — click **More info** → **Run anyway**.
